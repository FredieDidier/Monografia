...
outreg2	using "$ROOT/analysis/output/regressions/_table_regression_job_loss_determinants_with_interaction_2020_2-2021-3.tex", /*
	*/	title("") /*	
	*/	level(95) /*
	*/	dec(3) /*
	*/	fmt(fc) /*
	*/	label /*
	*/		/* depvar
	*/	keep(educ0 educ1 pandemic_2020_2_2021_3_educ0 pandemic_2020_2_2021_3_educ1)  /*
	*/	nocons	/*
	*/	addtext("Root mean squared error:", "`rmse_score'" ,  	/*
	*/ 	"F Statistic: No College + Pandemic 2020_2 - 2021_3*No College = Complete College + Pandemic 2020_2 - 2021_3*Complete College:", "`fstat'" , /*
	*/ 	"\hspace{1mm} P-value:", "`pvalue'" ,  /*
	*/ 	"State FE", "-", "Urban FE", "-", "Time-varying observables", "-", "Occupation and sector FE", "-" )	 /* 
	*/	tex(fragment) /*
	*/	replace
