...
tsline fitted_values_educ1 fitted_values_educ4 /// fitted_values_educ2 fitted_values_educ3
	...
	saving("$ROOT/analysis/tmp/_graph_regression_formal_nofe_job_loss_determinants.gph", replace)	
...
********************************************************************************
	...
	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_formal_nofe_job_loss_determinants.gph"
	*erase "$ROOT/analysis/graph/_graph_regression_formal_nofe_job_loss_determinants.gph"	
	graph export "$ROOT/analysis/output/graph/_graph_regression_formal_nofe_job_loss_determinants.png", replace	
