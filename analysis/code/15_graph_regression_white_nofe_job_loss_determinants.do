...
signed_work_card i.job_function hours_worked temporary_worker social_security_taxpayer i.gender age monthly_work_income i.job_start ///
i.year_quarter ///
...
tsline fitted_values_educ0 fitted_values_educ1 ///
    ...
    lcolor(gs11 gs1 gs11%60 gs11%60 gs1%40 gs1%40) ///
	title("White")	///
	subtitle("") ///
	xtitle("") ///
	...
	yscale( axis(1) range(0.13 0.22) lstyle(none)  ) ///
	...
	saving("$ROOT/analysis/tmp/_graph_regression_white_nofe_job_loss_determinants.gph", replace)	
...
********************************************************************************
	...
	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_white_nofe_job_loss_determinants.gph"
