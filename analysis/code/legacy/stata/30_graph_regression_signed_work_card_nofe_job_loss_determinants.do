...
tsline fitted_values_educ0 fitted_values_educ1 ///
	...
	saving("$ROOT/analysis/tmp/_graph_regression_signed_work_card_nofe_job_loss_determinants.gph", replace)	
...
********************************************************************************
	...
	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_signed_work_card_nofe_job_loss_determinants.gph"
	*erase "$ROOT/analysis/graph/_graph_regression_formal_nofe_job_loss_determinants.gph"	
	graph export "$ROOT/analysis/output/graph/_graph_regression_signed_work_card_nofe_job_loss_determinants.png", replace	
