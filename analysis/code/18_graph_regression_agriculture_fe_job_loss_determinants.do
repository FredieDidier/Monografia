...
* Regression for sectors == Agriculture with fixed effects 
...
coefplot (save_estimates, label(nome da especificacao))  	/*
	...
	*/ 	scheme(s2color ) /*
	*/ 	saving("$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ2.gph", replace) 
	

	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ2.gph"
	*erase "$ROOT/analysis/graph/_graph_regression_job_loss_determinants_educ2.gph"	
	graph export "$ROOT/analysis/output/graph/_graph_regression_agriculture_fe_job_loss_determinants_educ2.png", replace	
...
coefplot (save_estimates, label(nome da especificacao))  	/*
	...
	*/ 	ciopts(recast(rcap))  color(*.8) 	/* barwidth(0.10) 
	*/ 	scheme(s2color ) /*
	*/ 	saving("$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ3.gph", replace) 
	
	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ3.gph"
	*erase "$ROOT/analysis/graph/_graph_regression_job_loss_determinants_educ3.gph"	
	graph export "$ROOT/analysis/output/graph/_graph_regression_agriculture_fe_job_loss_determinants_educ3.png", replace	
...
coefplot (save_estimates, label(nome da especificacao))  	/*
	...
	*/ 	ciopts(recast(rcap))  color(*.8) 	/* barwidth(0.10) 
	*/ 	scheme(s2color ) /*
	*/ 	saving("$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ4.gph", replace) 
	
	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ4.gph"
	*erase "$ROOT/analysis/graph/_graph_regression_job_loss_determinants_educ4.gph"	
	graph export "$ROOT/analysis/output/graph/_graph_regression_agriculture_fe_job_loss_determinants_educ4.png", replace	
	
* combine graphs
graph combine "$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ2.gph" "$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ3.gph" "$ROOT/analysis/tmp/_graph_regression_agriculture_fe_job_loss_determinants_educ4.gph", /*
	*/ ycommon /*
	*/ xcommon /*
	*/ cols(1) /*
	*/ scheme(s2color) /*
	...
	* save graph 
	graph export "$ROOT/analysis/output/graph/_graph_regression_agriculture_fe_job_loss_determinants.png", replace	
