...
* Regression for position_names == Formal with no fixed effects 

 keep if position_names == "Informal"
...
tsline fitted_values_educ0 fitted_values_educ1 ///
	...
	yscale( axis(1) range(0.05 0.35) lstyle(none)  ) ///
	...
	saving("$ROOT/analysis/tmp/_graph_regression_informal_nofe_job_loss_determinants.gph", replace)	
...
********************************************************************************
	...
	* save graph 
	graph use "$ROOT/analysis/tmp/_graph_regression_informal_nofe_job_loss_determinants.gph"
	*erase "$ROOT/analysis/graph/_graph_regression_informal_nofe_job_loss_determinants.gph"	
	graph export "$ROOT/analysis/output/graph/_graph_regression_informal_nofe_job_loss_determinants.png", replace	
