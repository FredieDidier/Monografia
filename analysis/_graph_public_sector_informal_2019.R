...
serv_s_cart = serv_s_cart %>%
  ...
  distinct() %>%
  mutate(labelll = case_when(higher_educ_label == "Uneducated and Primary School Incomplete" & year_quarter == "2019_1" ~ 10,
                             higher_educ_label == "Primary School Complete and Incomplete High School" & year_quarter == "2019_1" ~ 8,
                             higher_educ_label == "Complete High School and Incomplete College Degree" & year_quarter == "2019_1" ~ 44,
                             higher_educ_label == "Complete College Degree" & year_quarter == "2019_1" ~ 38)) %>%
  filter(!is.na(labelll))

serv_s_cart = serv_s_cart[c(6,5,1,2),]
...
nov_grafico = ggplot(serv_s_cart, aes(x = "", y = labelll,
  ...
  labs(x = "", y = "",
       title = "Education Level of Informal Public Sector Employees in 2019") +
  theme_minimal() +
