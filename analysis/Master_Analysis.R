...
###########################################
#                                         #
# 4) Gerar graficos de transicao 2012-2021#
#                                         #
###########################################

source("./analysis/_graphs.R")

ggsave("transicao_formal_desempregado.png", path = "./output",
       width = 11.19, height = 6.64)

ggsave("transicao_informal_desempregado.png", path = "./output",
       width = 11.19, height = 6.64)

ggsave("transicao_formal_informal.png", path = "./output",
       width = 11.19, height = 6.64)

ggsave("transicao_formal_inativo.png", path = "./output",
       width = 11.19, height = 6.64)
...
ggsave("unemployed.png", path = "./output", width = 11.19,
       height = 6.64)
